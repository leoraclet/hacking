...
# wavfile.write("USB1.wav", sample_rate, stereo_int16)

data = [0x12 ,0x01 ,0x00 ,0x02 ,0x81 ,0x02 ,0x01 ,0x40 ,0xE7 ,0x1A ,0x3F ,0x9C ,0x00 ,0x01 ,0x01 ,0x02 ,0x03 ,0x01]
print(len(data))

print('404CTF{', end="")
print(hex(data[4])[2:] + "|", end="")
print(hex(data[8])[2:] + hex(data[9])[2:] + "|", end="")
print(hex(data[10])[2:] + hex(data[11])[2:], end="")
print("}")
